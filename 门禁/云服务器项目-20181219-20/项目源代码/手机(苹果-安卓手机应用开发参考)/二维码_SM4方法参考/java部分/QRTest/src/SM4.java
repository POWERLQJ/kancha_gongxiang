...
public class SM4{
    ...
    public int SM4Operate(byte[] in, int inLen, byte[] key, byte[] out, int CryptFlag) {
        int point = 0;
    ...
    public static byte[] encodeSM4(String plaintext, byte[] key) {
        ...
        return SM4.encodeSM4(plaintext.getBytes(), key);
    }
     ...
     * @return
     */
    public static String decodeSM4toString(byte[] ciphertext, byte[] key) {
        byte[] plaintext = new byte[ciphertext.length];
     ...
     * @return
     */
    public static byte[] encode16(byte[] plaintext, byte[] key) {
        byte[] cipher = new byte[16];
        SM4 sm4 = new SM4();
        sm4.SM4Operate(plaintext, 16, key, cipher, ENCRYPT);
    ...
    public static byte[] decode16(byte[] ciphertext, byte[] key) {
        ...
        SM4 sm4 = new SM4();
        sm4.SM4Operate(ciphertext, 16, key, plain, DECRYPT);
