...
//		String watchServerIP = "10.0.1.14"; //云服务器或测试电脑的IP地址  "192.168.168.101";
		String watchServerIP = "47.101.164.199"; //"111.230.128.68"; //云服务器或测试电脑的IP地址  "192.168.168.101";
...
//		pkt.CommClose();
	...
	public static int WatchingServerRuning(String watchServerIP,int watchServerPort) // 进入服务器监控状态
	{
        ...
        System.out.println(watchServerIP);
        System.out.println(watchServerPort);
...
//2018-10-16 18:05:15				         if (1<0)  //暂时屏蔽掉 显示数据部分
					         ...
					         if ((recvBuff[1]== 0x20) )
									{
										...
										log(String.format("2接收到来自控制器SN = %d 的数据包..记录索引号=%d##########", sn, recordIndexGet));
	...
	//											if (recordIndex < recordIndexGet)
					         ...
					         else  if ( (recvBuff[1]== 0x22))  //2018-07-10 10:39:43 增加0x22
								{
						            ...
						            long cmdSequenceId = WgUdpCommShort4Cloud.getLongByByte(recvBuff, 40, 4); //2017-09-07 15:56:06 流水号
						            if (qrDataLen >= 1) //2017-09-07 15:49:29 有二维码数据
						            {
						                ...
						                System.out.println(Arrays.toString(qrData));
						                ...
						                log("sfx");
						            	String a=TestShort.sendGet("http://kancha.ixn123.com/home/open/open", "snid="+ new String (qrData));
